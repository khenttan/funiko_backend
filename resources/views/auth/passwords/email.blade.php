...
<div class="login-logo">
        <a href="/"><strong style="color:purple">Forgot Password</strong></a>
    </div>
<div class="login">
    
    <img src="{{asset('img/idle/1.png')}}" id="monster" alt="">
    <form id="emailForm" action="{{ route('password.email') }}" accept-charset="UTF-8" method="POST" class="formulario">
        @csrf
        <label>Email</label>
