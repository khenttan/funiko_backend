...
@section('content')
            ...
            <div class="card card-primary">
                ...
                <form id="admin-profile" method="POST" action="{{ $selectedNavigation->url . "/" . user()->id }}" accept-charset="UTF-8" enctype="multipart/form-data">
                                ...
                                <div class="col col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="fullname" class="form-control {{ form_error_class('fullname', $errors) }}" placeholder="fullname" value="{{ ($errors->any()? old('fullname') : user()->fullname) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-6">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            <input type="password"  autocomplete="off" class="form-control {{ form_error_class('password', $errors) }}" id="password" name="password" placeholder="Password" value="" >
