...
<head>
    ...
    <link rel="stylesheet" href="/developer/admin/css/style.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/css/intlTelInput.css" />
    <!-- <link rel="stylesheet" href="{{asset('developer/admin/css/intlTelInput.css')}}" /> -->
    <script src="{{asset('developer/admin/js/intlTelInput.min.js')}}"></script>
    @yield('styles')
</head>
...
<body class="hold-transition sidebar-mini">
    ...
    @include('notify::notify') @include('admin.partials.modals')

    <script type="text/javascript" charset="utf-8" src="/js/admin.js?v={{ config('app.assets_version') }}"></script>

    @yield('scripts') @if(config('app.env') !== 'local')
    @include('partials.analytics') @endif

    <script type="text/javascript" charset="utf-8" src="/developer/admin/js/bootstrapValidator.min.js"></script>  
    <script src="{{asset('developer/admin/js/formvalidation.js')}}"></script>
