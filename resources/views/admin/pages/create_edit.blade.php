...
@section('content')
    ...
    <form id="page_admin" method="POST" class="card card-primary" action="{{$selectedNavigation->url . (isset($item)? "/{$item->id}" : '')}}" accept-charset="UTF-8">
        {!! csrf_field() !!}
                ...
                <div class="row">
                    <div class="col col-12">
                        <div class="form-group">
                              ...
                              <select name="lang_id" class="form-control" id="sel1">
                                <option value="">Select Language</option>
                                
                                <option value="ge">German</option>
                                <option value="en">English</option>
                              </select>
                               {!! form_error_message('lang_id', $errors) !!}
                        </div>
                    </div>
                </div>
                @endif
                    ...
                    <div class="col col-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input readonly type="text" class="form-control {{ form_error_class('slug', $errors) }}" id="slug" name="slug" placeholder="Enter Slug" value="{{ ($errors && $errors->any()? old('slug') : (isset($item)? $item->slug : '')) }}">
