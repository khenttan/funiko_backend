...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <form id="category" method="POST" action="{{$selectedNavigation->url . (isset($item)? "/{$item->id}" : '')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if(isset($item))
                                @php
                                if (($key = array_search($item->name ,$parents )) !== false) {
                                    unset($parents[$key]);
                                }
                                @endphp
                                @endif
